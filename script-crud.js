  ...
  if (tarefa.completa) {
    ...
    li.onclick = () => {
      ...
      if (tarefasSelecionada === tarefa) {
        ...
        liTarefasSelecionada = null;
        return;
      }
      tarefasSelecionada = tarefa;
      liTarefasSelecionada = li;
...
document.addEventListener("FocoFinalizado", () => {
  if (tarefasSelecionada && liTarefasSelecionada) {
    liTarefasSelecionada.classList.remove("app__section-task-list-item-active");
    liTarefasSelecionada.classList.add("app__section-task-list-item-complete");
    liTarefasSelecionada
